...
function hospital_menu() {
	...
	add_submenu_page('hospital', 'Doctor', __( 'Doctor', 'hospital_mgt' ), 'administrator', 'hmgt_doctor', 'doctor_function');
	add_submenu_page('hospital', 'Inpatient', __( 'Inpatient', 'hospital_mgt' ), 'administrator', 'hmgt_patient', 'patient_function');
	add_submenu_page('hospital', 'Outpatient', __( 'Outpatient', 'hospital_mgt' ), 'administrator', 'hmgt_outpatient', 'outpatient_function');
